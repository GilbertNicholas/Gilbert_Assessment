...
class Transaction_Data_Formatting: XCTestCase {
    ...
    let tranData4 = TranData(transactionId: "4", amount: 700, transactionDate: "2022-02-02T07:39:38.596Z", description: "test4", transactionType: "transfer", receipient: Stakeholder(accountNo: "6554-630-9653", accountHolder: "Andy"), sender: nil)
    ...
    func test_grouping_data_transaction_based_on_date_difference() {
        let dataTransaction: [TranData] = [tranData1, tranData2, tranData3, tranData4]
        
        let sortedData = transactionViewModel.formattingDateTransaction(transactionData: dataTransaction)
        
        XCTAssertEqual(3, sortedData.count)
    }
}
